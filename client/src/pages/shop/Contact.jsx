  ...
  return (
    <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="space-y-6">
        <div>
          <p className="text-sm font-semibold uppercase tracking-normal text-clay">Contact Us</p>
        ...
        <div className="space-y-3">
          <div className="flex gap-3 rounded-md border border-neutral-200 bg-white p-4 shadow-soft">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-md border border-neutral-200 bg-white p-6 shadow-soft">
        {sent && (
        ...
        <label className="block">
          ...
          <textarea
            className="min-h-36 w-full rounded-md border border-neutral-300 px-3 py-2 outline-none focus:border-ink focus:ring-2 focus:ring-skysoft"
            name="message"
            value={form.message}
